# Aryan Kundu 25BCE11217

#Currency Converter in python programming language

def ind_to_euro(n):          #defining the functions
    euro=n*0.0097
    print(euro," Euro :) ")
...
while (ans in ("Yes","yes")):               #while loop
